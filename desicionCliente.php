    ...
    <body>
        <div class="container">
            ...
            if ($existeCliente) {
                ...
                ?>
                <label>Bienvenido de vuelta <?php echo $nombre; ?>!!</label>

                <h3>Que desea realizar?</h3>
                <form action="validarCliente.php" method="post">
                    <div class="form-group">                  
                        <input type="hidden" class="form-control" name="cedula" required="true" value="<?php echo $cedula; ?>">
                    </div>                 
                    <button type="submit" class="btn btn-success btn-block">Pagar un servicio</button>
                </form>
                <form action="estadoDeudas.php" method="post">
                    <div class="form-group">                  
                        <input type="hidden" class="form-control" name="cedula" required="true" value="<?php echo $cedula; ?>">
                    </div>                 
                    <button type="submit" class="btn btn-default btn-block">Ver estado de mis deudas</button>
                </form>               
                <?php
            } else {
                ?>              
