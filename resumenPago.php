...
WHERE
	c.cedula = $cedula  order by 1 desc limit 1";
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <label>Resumen de Pagos a realizar:</label>          
                ...
                <tbody>                                       
                    ...
                    if (isset($datosServicios)) {
                        foreach ($datosServicios as $row) {
                            echo "<tr><td>" . $row['nro'] . "</td><td>" . $row['fecha'] . "</td><td>" . $row['nombre'] . "</td><td>" . $row['concepto'] . "</td><td>" . $row['monto'] . "</td>"
                            . "<td><form action='crearDeuda.php' method='POST'>"
                            ...
                            . "<input type='submit' class='btn btn-success' name='crear' value='Procesar Pago'>"
                            . "</form></td></tr>";
                        }
                    }
                    ?>
            ...
            <p><button type="button" onclick="location.href = 'index.php'" class="btn btn-default">Volver</button></p>
        </div>
    </body>
</html>
